  ...
  configs: [
    %{
      ...
      checks: [
        ...
        {Credo.Check.Refactor.CyclomaticComplexity, priority: :high, exit_status: 2, max_complexity: 13},
        ...
        {Credo.Check.Refactor.Nesting, max_nesting: 4, priority: :high, exit_status: 2},
